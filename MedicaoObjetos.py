...
webcam = False
path = "C:/Users/Mi/Documents/GitHub/Opencv-Yolo/images/A4-PADRAO.jpg"
cap = cv2.VideoCapture(0)
cap.set(3, 1920)# largura = 1920
cap.set(4, 1080)# altura = 1080
cap.set(10, 160)# brilho = 160
#################################

while True:
    if webcam:check, img = cap.read()
    else:img = cv2.imread(path)

    img = cv2.resize(img, (0, 0), None, 0.4, 0.4)
    img, conts = Utils.getContours(img, showCanny=True, draw=True, minArea=5000, filter=4)
    if conts != 0:
        biggest = conts[0][2]
        print(biggest)
